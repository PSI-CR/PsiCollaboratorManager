$(function () {
    $grid = $("#jqGrid").jqGrid({
        ...
        datatype: 'json',
        shrinkToFit: false,
        colNames: ['JornadaId', 'Jornada', 'Descripción', 'Jornada Acumulativa', 'Máximo Dias', 'Máximo Horas', 'Hora Inicial', 'Hora Final'],
        colModel: [
            ...
            { name: 'Accumulative', index: 'Jornada Acumulativa', width: 166, editable: true, align: 'center', editrules: { required: true } },
